...
public class RoomController {
    ...
    public ResponseEntity<Response> addNewRoom(
        ...
        if (roomType == null || roomType.isBlank() || roomPrice == null) {
            ...
            response.setMessage("Please provide values for all fields(photo, roomPrice)");
    ...
    public ResponseEntity<Response> updateRoom(@PathVariable Long roomId,
        ...
        Response response = roomService.updateRoom(roomId, roomType, roomPrice, roomDescription);
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }
